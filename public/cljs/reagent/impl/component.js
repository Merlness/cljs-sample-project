...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__9061 = c;
var G__9061__$1 = (((G__9061 == null))?null:G__9061.prototype);
if((G__9061__$1 == null)){
return null;
} else {
return G__9061__$1.reagentRender;
}
})() == null)))));
});
...
while (G__9066__i < G__9066__a.length) {G__9066__a[G__9066__i] = arguments[G__9066__i + 0]; ++G__9066__i;}
  args = new cljs.core.IndexedSeq(G__9066__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__9072 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__9073 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__9073);

try{return reagent.impl.component.wrap_render.call(null,c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__9072);
}});
...
var c = this;
var G__9076_9078 = reagent.impl.component.goog$module$goog$object.get.call(null,c,"cljsRatom");
if((G__9076_9078 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__9076_9078);
}
...
var renders_9079 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_9080 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_9079));
...
if((cljs.core.count.call(null,renders_9079) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_9079))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_9080)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_9080)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__9081 = o;
reagent.impl.component.goog$module$goog$object.set.call(null,G__9081,cljs.core.name.call(null,k),v);
...
while (G__9083__i < G__9083__a.length) {G__9083__a[G__9083__i] = arguments[G__9083__i + 0]; ++G__9083__i;}
  args = new cljs.core.IndexedSeq(G__9083__a,0,null);
} 
...
var vec__9089 = reagent.impl.component.global$module$react.useState((0));
var _ = cljs.core.nth.call(null,vec__9089,(0),null);
var update_count = cljs.core.nth.call(null,vec__9089,(1),null);
...
var G__9092 = reagent.impl.component.goog$module$goog$object.get.call(null,reagent_state,"cljsRatom");
if((G__9092 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_.call(null,G__9092);
}
});
}),[]);
